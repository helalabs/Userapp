      ...
      for (final barcode in barcodes) {
        ...
        if(_name != null && _phone != null && _type != null && _image != null) {
          ...
          if(isHome && _type != "agent"){
            ...
            Get.to(()=>  TransactionMoneyBalanceInput(transactionType: _transactionType,contactModel: ContactModel(phoneNumber: _phone, name: _name,avatarImage: _image), countryCode: '',));
          }
